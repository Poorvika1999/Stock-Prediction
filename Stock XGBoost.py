...
# df_gb = df.groupby(['month'], as_index=False).agg({'close':'mean'})
# df_gb = df_gb.rename(columns={'close':'close_mean'})
# df_gb
...
print("min MAPE = %0.3f%%" % error_rate['mape_pct'].min())
print("optimum params = ")
print(temp['learning_rate'].values[0], temp['min_child_weight'].values[0])
...
print("min MAPE = %0.3f%%" % error_rate['mape_pct'].min())
print("optimum params = ")
print(temp['subsample'].values[0], temp['gamma'].values[0])
...
print("min MAPE = %0.3f%%" % error_rate['mape_pct'].min())
print("optimum params = ")
print(temp['colsample_bytree'].values[0], temp['colsample_bylevel'].values[0])
